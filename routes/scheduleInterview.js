...
router.post('/', async (req, res) => {
  try {
    ...
    if (!validated.error) {
      ...
      let user = await functions.runQuery(`insert into scheduleInterview (userid , jobid , datetime ,isjobaccept  ) , (${req.body.userid}  , ${req.body.jobid}  , '${currentTime}' , ${req.body.isjobaccept} )`);
